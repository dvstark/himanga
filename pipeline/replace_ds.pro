...
;
; @version $Id$
;-07-Feb-2017 (DS): adjusted code so it would return the channels that
;wer clicked

pro replace,bchan,echan,zero=zero,blank=blank,sortlist=sortlist
    ...
    if n_elements(bchan) eq 0 and n_elements(echan) eq 0 then begin
        ...
        print,'clicked channels: ',sortlist
