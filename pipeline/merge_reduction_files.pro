pro merge_reduction_files,input_paths,output_path,log=log,overwrite=overwrite,make_catalog=make_catalog,nocopy=nocopy,nile_mod=nile_mod
...
merge_reduction_files,'/users/dstark/17AGBT012/reduced/'+['cfielder_copy','cwithers_copy','dfinnega','dstark','eharring','ewarrick','jgoddy','kmasters','nsamanso','nwolthui','pfofie_copy','reaglin','sdillon_copy','sshamsi']+'/final/','/users/dstark/17AGBT012/master/reduction_files/',log='file_merge_log_30Jun2020.txt',/nile_mod
